...
obj.bg_panel = obj.initialize_bg_panel(g);                        % Background panel
obj.br_panel = []; %obj.initialize_br_panel(g);                   % Backreflection panel
...
top_spacer = obj.spacers.top_spacer; % px
h_spacer = obj.spacers.h_spacer; % px
v_spacer = obj.spacers.v_spacer; % px
b_spacer = obj.spacers.bottom_spacer; % px; bottom spacer
